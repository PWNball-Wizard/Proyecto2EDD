...
public class Nodo implements Serializable
{
    ...
    private int num = 0;
    private String etqs[] = new String[2];
    ...
    public Nodo(Object obj, String etq, String etqs[]) //para los contactos
    {
        this.obj = obj;
        this.etq = etq;
        this.etqs = etqs;
    ...
    public Nodo(Object obj, String etq, int num, Object pila1, Object pila2) //para el historial
    {
        this.obj = obj;
        this.etq = etq;
        this.num = num;
