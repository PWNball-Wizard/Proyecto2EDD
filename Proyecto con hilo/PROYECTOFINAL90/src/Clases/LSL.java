    ...
    public boolean inserta(Nodo n) //RECIBE EL ELEMENTO A INSERTAR
    {
        ...
        if (n == null) //1. si el nodo es null no inserta nada
        {
            ...
            if (r == null) {
                ...
                if (n.getEtq().compareTo(r.getEtq()) < 0) // compara lo que tiene r con el dato que llego 
                ...
                //si es menor a 0 lo que esta en n es menor a r
                {
                    ...
                    while (aux.getSig() != null && b) //recorrido de la lista mientras no llegue al final
                    {
