...
public class VtnContacto extends javax.swing.JFrame {
    ...
    public boolean validaE(String s)//valida que no haya espacios al principio y al final de la palabra
    {
        ...
        {
            /*if (s.charAt(largo)==32) 
            {
                validaE=false;
                Mensaje.error(this,"No se permiten espacios en blanco al final de la palabra");
            } 
            else 
            {*/
                validaE=true;
        ...
        s = JOptionPane.showInputDialog("Escriba el nombre del contacto que desea agregar");
            ...
            //Evita el NPE al salir del showInputDialog o presionar cancelar
                ...
                if (valida(s) == false) {
                    ...
                    if (validaC(r1, s) == true) {//VALIDA QUE EL NOMBRE NO ESTE REPETIDO k
                        ...
                        if (validaE(s)==false) {
                            ...
                            if (c.validaN(s) == true) {//VALIDA QUE EL NOMBRE DE CONTACTO NO SE ENCUENTRE REPETIDO EN OTRO GRUPO
                                Mensaje.error(this, "El nombre que desea ingresar se encuentra ya en otro grupo");
                            } else {
                                //AQUI COMIENZA EL PROCESO DE ALTAS

                                //s=s.trim();
                                //CAMBIA LA PRIMERA LETRA DEL NOMBRE DEL CONTACTO A MAYUSCULA
                                //LO HACE TOMANDO LA PRIMERA LETRA DE LA CADENA, Y LUEGO CONCATENANDOLA CON LA MISMA CADENA MENOS LA PRIMERA LETRA
                                //SUBSTRING LO QUE HACE ES ELIMINAR EL PRIMER CARACTER
                                ...
                                etqs[1] = s2;//TOMA EL VALOR QUE SE MODIFICO
                                
                                Nodo con = new Nodo(null, s2.trim(),etqs);//SE CREA EL NODO Y SE ELIMINAN LOS SESPACIOS QUE PUDIERA TENER

                                NodoArbol nomNAS = new NodoArbol(s2.trim(), null, con);//CREA EL NODO PARA INSERTAR EN EL ARBOL
                                ...
                                r1 = Multilistas.busca(VtnGrupo.r, d); //BUSCA EL GRUPO
                                r1 = r1.getAbj();//BAJA DE NIVEL
                                JPContactos.removeAll();// PRIMERO ELIMINA TODOS LOS BOTONES

                                if (r1 != null) {//SI ES DIFERENTE DE NULO CREA LOS BOTONES
                                    Nodo aux = r1;
                                    while (aux != null) {
                                        ...
                                        boton.addActionListener(new ActionListener() {
                                            ...
                                            public void actionPerformed(ActionEvent e) {
                                                //IGUAL QUE EN LOS OTROS METODOS SI UN BOTON ES PRESIONADO ENTONCES PASA LOS DATOS DE
                                                //GRUPO Y CONTACTO A LAS VARIABLES DE LA SIGUIENTE VENTANA Y LA HACE VISIBLE
    ...
    private void jBMoverCActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBMoverCActionPerformed
        ...
        if (nom == null) //EVITA QUE SALGA EXCEPCION AL DAR CANCELAR O SALIR
        {
            b1 = false;//B1 SE HACE FALSA
            //Evita el NPE al salir del showInputDialog o presionar cancelar
        } else 
            if (validaBE(nom) != false) 
            {
